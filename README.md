...
A Rust-based autonomous worker designed to maintain database health by pruning outdated records generated by the Man-in-the-Middle (MitM) Data Aggregator pipeline. 
...
```bash
cd maintenance-layer/mitm_cleanup
cargo build --release --target x86_64-unknown-linux-musl
cp target/x86_64-unknown-linux-musl/release/mitm_cleanup ../../bin/
```
